...
<section class="min-h-screen">
	<div>
		...
		<h1 class="main-heading font-outfit text-[6rem] lg:text-[5rem] md:text-[4rem] sm:text-[3rem]">
			<span>{name}.</span><br />
	...
	>
		<span class="group-hover:text-marrsgreen dark:group-hover:text-carrigreen"> Scroll </span>
